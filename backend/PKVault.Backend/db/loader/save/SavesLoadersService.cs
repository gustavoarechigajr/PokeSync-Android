...
) : ISavesLoadersService
{
    ...
    )> ReadSaveFiles()
    {
        ...
        // User-configured globs + host auto-detected emulator globs (Android live save dirs).
        var globs = (string?[])[.. settingsService.GetSettings().SettingsMutable.SAVE_GLOBS, .. SettingsService.AutoSaveGlobs];
